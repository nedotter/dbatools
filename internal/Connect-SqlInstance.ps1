function Connect-SqlInstance {
	...
	$tempserver = New-Object Microsoft.SqlServer.Management.Smo.Server (New-Object System.Data.SqlClient.SqlConnection (New-DbaSqlConnectionString -SqlInstance $SqlInstance -SqlCredential $SqlCredential -ClientName "dbatools PowerShell module - dbatools.io"))
	$server = New-Object Microsoft.SqlServer.Management.Smo.Server($tempserver.ConnectionContext.Copy())
	$tempserver.ConnectionContext.Disconnect()
	Write-Warning $server.Connectioncontext.ConnectionString
